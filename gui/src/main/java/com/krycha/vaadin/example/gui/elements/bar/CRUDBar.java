...
public class CRUDBar extends CustomComponent {
	...
	private TextChangeListener findListener;
	/**
	...
	public CRUDBar() {
		...
		findField.addTextChangeListener(new TextChangeListener() {
			...
			public void textChange(TextChangeEvent event) {
				if (!"".equals(event.getText()) && findIcon.isVisible()) {
					findIcon.setVisible(false);
					find.setVisible(true);
				}
				if (findListener != null) {
					findListener.textChange(event);
				}
			}
		});
		...
		find.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				if (findListener != null) {
					findListener.textChange(new TextChangeEvent(findField) {
	...
	public void findTextChangeListener(TextChangeListener textChangeListener) {
		findListener = textChangeListener;
	}
	...
	private HorizontalLayout buildHorizontalLayout_2() {
		...
		find.setStyleName("crudbutton");
		find.setCaption("");
		find.setIcon(new ThemeResource("icons/find_24px.png"));
		find.setImmediate(true);
		find.setVisible(false);
		find.setWidth("-1px");
		find.setHeight("-1px");
		horizontalLayout_2.addComponent(find);

		// findField
		findField = new TextField();
		findField.setImmediate(false);
		findField.setWidth("175px");
