...
public class Content extends CustomComponent implements View {
	...
	private static final String MAIN_NAV = "main";
	private Menu menu;
	 ...
	 * editor.
	 */
	public Content(UI ui) {
		buildMainLayout();
		setCompositionRoot(mainLayout);

		menuViews.put(DEFAULT_NAV, new WelcomeView());

		navigator = new Navigator(ui, panel);
		navigator.addView(MAIN_NAV, this);
		...
		menu.addMenuListener(new MenuEvent() {
			@Override
