...
public class Menu extends CustomComponent implements ClickListener {
	...
	private List<MenuEvent> menuEvents = new ArrayList<MenuEvent>();
	private Map<String, MenuButton> menuButtons = new HashMap<String, MenuButton>();
	...
	private void buildMenu() {
		for (MenuElement menu : MenuElement.values()) {
			...
			menuButtons.put(menu.getItemName(), item);
		}
	}
	...
	public void buttonClick(String itemName) {
		...
		buttonClick(new ClickEvent(menuButtons.get(itemName)));
	}
