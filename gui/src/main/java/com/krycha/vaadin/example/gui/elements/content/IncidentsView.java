...
public class IncidentsView extends CustomComponent {
	...
	public IncidentsView() {
		...
		incidentsTable.setConverter("date", new Converter<String, DateTime>() {
			private static final long serialVersionUID = 855371986709926776L;
			...
			public DateTime convertToModel(String value,
				...
				try {
					retVal = new DateTime(IncidentFormWindow.DATE_FORMAT.parse(value));
			...
			public String convertToPresentation(DateTime value,
					...
					throws ConversionException {
				return IncidentFormWindow.DATE_FORMAT.format(value.toDate());
			}
			...
			public void buttonClick(ClickEvent event) {
				...
				if (entity.getCustomer() != null) {
					captionString = String.format("Delete \"%s-%s-%s\"?", entity.getCustomer().getShortName(),
							entity.getMeasurement().getShortName(),
							IncidentFormWindow.DATE_FORMAT.format(entity.getDate().toDate()));
				}
		...
		crudBar.setSearchInputPrompt("Search by customer or measurement");
	}
	...
	private void updateFilters(String textFilter) {
		...
		if (textFilter != null && !textFilter.equals("")) {
			Or or = new Or(new Like("customer.shortName", "%" + textFilter + "%", false),
					new Like("measurement.shortName", "%" + textFilter + "%", false));
